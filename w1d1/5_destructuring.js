...
const { email: newEmailName, password } = person;
...
const { addresses: [ whiteHouse, sherlockHolmesAddress ] } = person;

console.log("\nDestructured:");
console.log("\nArray Third animal: " + thirdAnimal);
// => fish 

console.log("email: " + newEmailName);
console.log("pw: " + password)
console.log("Sherlock Holmes address: " + sherlockHolmesAddress);
console.log("\nSherlock Holmes address (showing values):");
console.log(sherlockHolmesAddress);
